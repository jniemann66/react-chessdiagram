...
class App extends Component {
  constructor(props) {
    ...
    this.gamePresets = {
      ...
      draughts: {
        fen:
          "1g1g1g1g1g/g1g1g1g1g1/1g1g1g1g1g/g1g1g1g1g1/10/10/1G1G1G1G1G/G1G1G1G1G1/1G1G1G1G1G/G1G1G1G1G1 w - - 0 1",
        files: 10,
        flip: false,
        gameHistory: false,
        ranks: 10,
        pieceDefinitions: {
          G: this._createPieceDefinition(
      ...
      courier: {
        fen:
          "rnbcmk1scbnr/1ppppp1pppp1/6q5/p5p4p/P5P4P/6Q5/1PPPPP1PPPP1/RNBCMK1SCBNR",
        files: 12,
        flip: false,
        gameHistory: false,
        ranks: 8,
        pieceDefinitions: {
          C: this._createPieceDefinition(
            "https://upload.wikimedia.org/wikipedia/commons/7/7c/Chess_Blt45.svg"
          ),
          c: this._createPieceDefinition(
            "https://upload.wikimedia.org/wikipedia/commons/5/5a/Chess_Bdt45.svg"
          ),
          M: this._createPieceDefinition(
            "https://upload.wikimedia.org/wikipedia/commons/1/17/Chess_flt45.svg"
          ),
          m: this._createPieceDefinition(
            "https://upload.wikimedia.org/wikipedia/commons/2/2c/Chess_fdt45.svg"
          ),
          S: this._createPieceDefinition(
            "https://upload.wikimedia.org/wikipedia/commons/c/ce/Chess_tlt45.svg"
          ),
          s: this._createPieceDefinition(
            "https://upload.wikimedia.org/wikipedia/commons/e/e2/Chess_tdt45.svg"
          )
        },
        pgn: ""
      }
    ...
    this.state = Object.assign(
      {},
      this.state,
      this.gamePresets[this.state.gameType]
    );
  }
  ...
  _onLabelsChanged(evt) {
    // rank/file labels on/off
    this.setState({ labels: evt.target.checked });
  }
  ...
  _onMovePiece(piece, fromSquare, toSquare) {
    // user moved a piece
  ...
  _onGameTypeChange(evt) {
    this.setState(
      Object.assign(this.gamePresets[evt.target.value], {
        gameType: evt.target.value
      })
    );
  }
    ...
    return (
      <div className="demo">
          ...
          <div className="propGroup">
            ...
            <p>
              ...
              <input
                ...
                onChange={this._onFlipChanged.bind(this)}
              />
            </p>
            <p>
              Rank/File labels?
              <input
                ...
                onChange={this._onLabelsChanged.bind(this)}
              />
            </p>
            <p>
              Light Square Color:
              <input
                type="color"
                value={this.state.lightSquareColor}
                onChange={this._onLightSquareColorChanged.bind(this)}
              />
            </p>
            <p>
              Dark Square Color:
              <input
                type="color"
                value={this.state.darkSquareColor}
                onChange={this._onDarkSquareColorChanged.bind(this)}
              />
            </p>
          </div>
          <div className="propGroup">
            <p>
              ...
              <select
                ...
                onChange={this._onGameTypeChange.bind(this)}
              >
            ...
            <p>
              ...
              <input
                ...
                min={2}
                max={16}
                onChange={this._onRanksChanged.bind(this)}
              />{" "}
              {this.state.ranks}
            </p>
            <p>
              ...
              <input
                ...
                min={2}
                max={16}
                onChange={this._onFilesChanged.bind(this)}
              />{" "}
              {this.state.files}
            </p>
          </div>
        ...
        <Chessdiagram
          ...
          pgn={this.state.pgn}
          pieceDefinitions={
            this.gamePresets[this.state.gameType].pieceDefinitions
          }
        ...
        <p className={"lastMessage"}>
          <strong>{this.state.lastMessage}</strong>
        </p>

        {this.state.pgn ? (
          <div style={{ position: "relative", top: 40 }}>
            Displaying the following PGN:
            <br />
            <textarea
              cols={60}
